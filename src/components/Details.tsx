...
export default function Details(props: IDetailsProps) {
  ...
  return (
    <Box className="flex flex-col sm:flex-row lg:flex-col lg:h-fit justify-evenly w-full lg:w-fit gap-6 p-4">
      ...
      {!isNotShow && (
        <>
          <Box className="flex bg-white border min-w-[300px] border-gray-300 rounded-md shadow-md p-4 flex-col gap-4 md:w-full md:justify-center items-start h-fit md:h-full">

            <Typography className="text-gray-800" variant="h6">published at: {dateFormat(createdAt!)}</Typography>
            ...
            <Box className="flex flex-row items-center justify-center text-center">
