...
const ViewsChart = () => {
    const [isFoundData, setIsFoundData] = useState(true);
    ...
    return (
        <Box className="h-full mx-4 overflow-x-auto">
            ...
            {isFoundData ? (
                ...
                <div className='flex w-full h-full shadow-lg rounded-md border bg-white p-3 flex-col justify-center items-center'>
